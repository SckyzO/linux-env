# Generated by Powerlevel10k configuration wizard on 2020-06-28 at 02:21 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # wifi                  # wifi speed
    fzf	                    # fzf is a powerful CLI finder. it can filters the lists any of matching character. also super fast!
    vagrant
